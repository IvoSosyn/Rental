...
public class Attrnumeric implements Serializable {
    ...
    public Attrnumeric(Object id) {
        this.id = id;
    }

    public Attrnumeric(Object id, Date timeinsert, Date timemodify) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Attrnumeric)) {
            return false;
        }
        Attrnumeric other = (Attrnumeric) object;
    ...
    public String toString() {
        return "cz.rental.entity1.Attrnumeric[ id=" + id + " ]";
    }
